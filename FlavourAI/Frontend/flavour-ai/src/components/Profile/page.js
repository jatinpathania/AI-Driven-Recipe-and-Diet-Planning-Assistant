...
export default function ProfileDashboard() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-r from-[#0e1425] to-[#060d18] text-white px-4 py-10">
      {/* Header */}
      <div className="w-full max-w-2xl flex flex-col sm:flex-row items-center justify-between mb-10">
      ...
      {/* Dashboard Box */}
      <div className="w-full max-w-2xl bg-gradient-to-b from-[#0e1425] via-[#1e2838] to-[#060d18] border border-gray-700 rounded-2xl shadow-xl p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          {/* GitHub */}
          <div>
            <label htmlFor="github" className="text-xs text-gray-400 mb-1 block">
              GitHub
            </label>
            <div className="relative">
        ...
        {/* Success Message */}
        {message && (
          <p className="text-center text-green-400 text-xs mt-3 animate-fadeIn">
            {message}
          </p>
        )}
      </div>
      ...
      <p className="text-gray-500 text-xs mt-8 text-center">
        © {new Date().getFullYear()} Flavour AI. All rights reserved.
      </p>
    </div>
  )
}
