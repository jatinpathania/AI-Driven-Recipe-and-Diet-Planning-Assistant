...
const StyledWrapper = styled.div`
  ...
  .popup {
    ...
    --nav-active-scale: 1;
    --nav-position-left: unset; /* Updated to unset */
    --nav-position-right: 0; /* Updated to 0 */
    /* title */
  ...
  .popup-window {
    ...
    left: var(--nav-position-left); /* Updated to use variable */
    right: var(--nav-position-right); /* Updated to use variable */
    transition: var(--burger-transition);
    margin-top: 10px;
  }
