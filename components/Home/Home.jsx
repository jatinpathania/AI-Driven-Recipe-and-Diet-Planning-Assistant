                                ...
                                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3">
                                    {['Tomato', 'Onion', 'Garlic', 'Ginger', 'Potato', 'Carrot', 'Bell Pepper', 'Spinach', 'Broccoli', 'Cauliflower', 'Peas', 'Corn', 'Mushroom', 'Eggplant', 'Zucchini', 'Cucumber'].map((veg) => (
                                        <motion.button
                                            ...
                                            className={`px-4 py-2.5 rounded-lg border-2 font-medium transition-all ${selectedVeggies.includes(veg)
                                                ...
                                                >
                                                    ...
                                                    <div className="p-6">
                                                        ...
                                                        <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                                                            <span className={`inline-block px-3 py-1 rounded-full text-xs font-semibold ${recipe.difficulty === 'Easy' ? 'bg-green-100 text-green-800' :
                            ...
                            >
                                <AnimatePresence mode="popLayout">
                                    {messages.map((msg, i) => (
                                        ...
                                        >
                                            <div className={`max-w-xs px-4 py-2.5 rounded-lg text-sm leading-relaxed ${msg.role === 'user'
